...
<div class="row">
    ...
    <div class="col text-end">
        <a href="/admin/airdrop/promo/create" class="btn text-white bg-primary fw-bold">
            Add new
        </a>
    </div>
</div>
...
<div class="row pt-2 mb-3">
    <div class="col">
        <form action="/admin/airdrop/promo" method="get" id="queryForm">
...
<div class="row mb-5">
    <div class="col">
        <table class="table table-bordered rounded mb-5 align-middle">
